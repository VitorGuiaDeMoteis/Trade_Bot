...
text = re.sub(r'    mode = getattr\(request\.app\.state, "mission_control_mode", "broker"\).*?return FileResponse\(PAGE, media_type="text/html", headers=headers\)', new_logic, text, flags=re.DOTALL)
