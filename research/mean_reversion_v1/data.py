...
DEFAULT_ARTIFACTS_DIR = Path(".artifacts/research/mean_reversion_v1")
SUBSTITUTIONS = {"SPY": "VOO", "IWM": "VTWO", "EFA": "VEA", "EEM": "IEMG"}
...
def fetch_yahoo(symbols: list[str], start: str, end: str) -> pd.DataFrame:
    ...
    downloaded = yf.download(
        symbols, start=start, end=exclusive_end, group_by="ticker", auto_adjust=True, progress=False
    )
