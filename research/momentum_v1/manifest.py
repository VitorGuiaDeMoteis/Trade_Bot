...
STRATEGY_DEFINITIONS: dict[str, dict[str, object]] = {
    ...
    "AM_PRIMARY": {"kind": "am", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "rebalance": "monthly"},
    "A1": {"kind": "am", "lookback_months": 6, "skip_months": 0, "absolute_filter": "tbill", "rebalance": "monthly"},
    "A2": {"kind": "am", "lookback_months": 12, "skip_months": 1, "absolute_filter": "tbill", "rebalance": "monthly"},
    "A3": {"kind": "am", "lookback_months": 12, "skip_months": 0, "absolute_filter": "zero", "rebalance": "monthly"},
    "A4": {"kind": "am", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "rebalance": "quarterly"},
    "RAM_PRIMARY": {"kind": "ram", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "k": 3, "rebalance": "monthly"},
    "R1": {"kind": "ram", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "k": 2, "rebalance": "monthly"},
    "R2": {"kind": "ram", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "k": 4, "rebalance": "monthly"},
    "R3": {"kind": "ram", "lookback_months": 6, "skip_months": 0, "absolute_filter": "tbill", "k": 3, "rebalance": "monthly"},
    "R4": {"kind": "ram", "lookback_months": 12, "skip_months": 1, "absolute_filter": "tbill", "k": 3, "rebalance": "monthly"},
    "R5": {"kind": "ram", "lookback_months": 12, "skip_months": 0, "absolute_filter": "tbill", "k": 3, "rebalance": "quarterly"},
}
...
def sealed_source_paths(root: Path) -> list[Path]:
    ...
    paths.extend([package / "config.json", root / "docs" / "MOMENTUM_EXPERIMENT_V1_3.md"])
