...
async def main():
    ...
    async with AlpacaPaperAdapter(api_key, secret_key) as adapter:
        ...
        run_id = uuid4()
        signal_id = uuid4()
        risk = RiskDecision(decision_id=uuid4(), signal_id=signal_id, decision="APPROVED", reason="test", decided_at=datetime.now(UTC))
        ...
        with engine.begin() as connection:
            ...
            # Instead of using the executor directly, we can just test the adapter or create a dummy run.
            pass
