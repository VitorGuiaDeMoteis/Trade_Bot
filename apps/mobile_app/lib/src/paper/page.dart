...
class PaperPage extends StatefulWidget {
  const PaperPage({super.key, this.controller});
...
class _PaperPageState extends State<PaperPage> {
  late final PaperController controller;
  @override
  void initState() {
    super.initState();
    controller = widget.controller ?? PaperController();
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              onPressed: controller.loadPortfolio,
            ),
          ],
          bottom: const TabBar(
            isScrollable: true,
        ...
        body: ListenableBuilder(
          ...
          builder: (context, _) {
            ...
            if (controller.error != null && controller.portfolio == null) {
              return Center(
                child: Text(
                  controller.error!,
                    ...
                    Card(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Status: ${controller.isPaused ? 'PAUSED' : p.status}',
                            ...
                            Text(
                              'Market Value: \$${p.marketValue.toStringAsFixed(2)}',
                            ),
                            Text(
                              'Unrealized PnL: \$${p.unrealizedPnl.toStringAsFixed(2)}',
                              style: TextStyle(
                                color: p.unrealizedPnl >= 0
                                    ? Colors.green
                                    : Colors.red,
                              ),
                            ),
                            Text(
                              'Realized PnL: \$${p.realizedPnl.toStringAsFixed(2)}',
                              style: TextStyle(
                            ...
                            Text(
                              'Total PnL: \$${p.totalPnl.toStringAsFixed(2)}',
                              style: TextStyle(
                                color: p.totalPnl >= 0
                                    ? Colors.green
                                    : Colors.red,
                            ...
                            if (controller.isPaused) ...[
                              ...
                              FilledButton.icon(
                                ...
                                label: const Text('PAUSAR SIMULAÇÃO'),
                              ),
                          ],
                        ),
                      ),
                ...
                p.fills.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            title: Text(
                              'Fill ${fill.quantity} @ \$${fill.price.toStringAsFixed(2)}',
                            ),
                            subtitle: Text(
                              'Fee: \$${fill.fee.toStringAsFixed(2)} | PnL: \$${fill.realizedPnl.toStringAsFixed(2)}',
                            ),
                          );
                        },
                      ),
